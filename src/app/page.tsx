        ...
        <section className="text-center py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-green-200 mb-12 max-w-2xl mx-auto">
              Publica en X sobre Tokenizados y gana 3 USDT. Solo para los
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6">
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <a
                  href="https://www.tiktok.com/@tokenizados"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-green-200 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 border border-white/20"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="https://www.youtube.com/@TOKENIZADOS-NET"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-green-200 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 border border-white/20"
                >
                ...
                <a
                  href="https://t.me/tokenizados_net"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-green-200 hover:text-white px-4 py-2 rounded-lg transition-all duration-200 border border-white/20"
                >
